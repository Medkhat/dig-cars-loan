...
import { applyMainStatus, useApplyBiometryMutation } from '@/features/api/apply-main';
...
const MainBiometryPage = () => {
  ...
  const [fetchBiometry, { isLoading }] = useApplyBiometryMutation();
...
export default MainBiometryPage;
